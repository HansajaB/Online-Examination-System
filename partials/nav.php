...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="infor.php">Exam Information</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="example.php">Exam Calander</a>
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="examregistration.php">Exam Registration</a>
          <a class="dropdown-item" href="examresults.php">Exam Results</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="#">Exam Details</a>
        </div>
      </li>
    </ul>
